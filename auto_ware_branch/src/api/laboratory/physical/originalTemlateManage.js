...
let instance = axios.create({
  baseURL: window.global.physicalAjaxBaseUrl + 'api/lab/report/labOriginalTemplateController',
...
// 获取含油实验模版
export const getAllCrudeSampleTemplate = params => {
  return instance.post('getAllCrudeSampleTemplate', params)
}
