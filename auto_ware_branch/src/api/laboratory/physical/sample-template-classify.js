...
var instance = axios.create({
  baseURL: window.global.physicalAjaxBaseUrl + 'api/lab/report/labDataGroupDicController',
...
// 原始记录单模版分类
export const getAllDicByType = params => {
  return instance.post('getAllDicByType', params)
}
