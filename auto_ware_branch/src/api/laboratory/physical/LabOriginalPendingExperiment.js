...
var instance = axios.create({
  baseURL: window.global.physicalAjaxBaseUrl + 'api/lab/report/LabOriginalPendingExperiment',
...
// 物检任务/实验任务/含油实验任务
export const getLabOriginalPendingExperimentByCrude = params => {
  return instance.post('getLabOriginalPendingExperimentByCrude', params)
}

// 物检任务/实验任务/含油实验任务
export const getLabOriginalPendingExperimentDetailsByGuideCrude = params => {
  return instance.post('getLabOriginalPendingExperimentDetailsByGuideCrude', params)
}

// 物检任务/实验任务/新增含油实验任务
export const createCrudeSampleLabOriginalPendingExperiment = params => {
  return instance.post('createCrudeSampleLabOriginalPendingExperiment', params)
}

// 含油实验任务/审核通过，生成记录
export const examineAndVerifyLabOriginalPendingDo = params => {
  return instance.post('examineAndVerifyLabOriginalPendingDo', params)
}
