...
// 新增丝车规格
export const addSilkcarSpec = params => { return instance.post('addSilkcarSpec', params) }
export const getSilkcarSpec = params => { return instance.post('getSilkcarSpec', params) }
export const updateSilkcarSpec = params => { return instance.post('updateSilkcarSpec', params) }
export const deleteSilkcarSpec = params => { return instance.post('deleteSilkcarSpec', params) }
export const getSilkcarSpecNoPage = params => { return instance.post('getSilkcarSpecNoPage', params) }
// 获取机位丝锭数
export const getDistinctSilkNum = params => { return instance.post('getDistinctSilkNum', params) }
