...
export const publicModule = [
  ...
  /* 用户管理 工厂配置 */
  {
    path: 'user-manage/factory-config',
    name: names.PUBLIC_FACTORY_CONFIG,
    component (resolve) {
      require(['../../components/public-platform/user-manage/factory-config/index.vue'], resolve)
    }
  },
  /* 用户管理 -- 工种设置 */
  {
    path: 'user-manage/job-setting',
    name: names.PUBLIC_USER_WORK__TYPE,
    component (resolve) {
