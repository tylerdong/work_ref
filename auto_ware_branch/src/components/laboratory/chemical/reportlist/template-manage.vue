    ...
    <div class="hy-admin__main-container">
      <div class="hy-admin__search-main cf">
        <div class="fr">
          ...
          <el-input class="search-input margin-right-10" v-model="query.name" placeholder="请输入名称"></el-input>
    ...
    methods: {
      ...
      getData () {
        let params = {
          ...
          queryLabRptlTemplateCo: this.query
        }
        this.loading.list = true
        api.chemicalLaboratory.labReportManage.getLabRptTemplateDoList(params).then((response) => {
          let data = response.data
          if (data.success) {
            this.page.total = data.data.count // 设置总数据条数
