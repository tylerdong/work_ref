  ...
  <div>
    <div>
      <el-table :data="tableData" border v-loading="loading.table" element-loading-text="拼命加载中">
        ...
        <el-table-column prop="aintenanceProject" label="维修项目" show-overflow-tooltip></el-table-column>
        <el-table-column prop="reporter" label="维修人" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getListData () { // 获取列表结构
        ...
        api.chemicalLaboratory.labInstrumentRepair.getLabInstrumentRepairDoList(params).then(response => {
