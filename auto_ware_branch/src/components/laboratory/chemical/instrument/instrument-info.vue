...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      add (params) {
        api.chemicalLaboratory.labInstrumentManagement.createLabInstrumentManagementDo(params).then(response => {
      ...
      update (params) {
        api.chemicalLaboratory.labInstrumentManagement.updateLabInstrumentManagementDo(params).then(response => {
          const data = response.data
          if (data.success === true) {
            this.$emit('success')
          }
