    ...
    <jk-dialog :title="form.title" :visible.sync="dialogVisible">
      <div ref="formDom">
        <el-form :model="form" :rules="formRules" ref="ruleForm" label-width="100px">
          <el-form-item label="标样模板" prop="region">
...
//        })
        ...
        api.chemicalLaboratory.LabOriginalPendingExperiment.createGuideSampleLabOriginalPendingExperiment(params).then(response => {
          const data = response.data
          if (data.success === true) {
