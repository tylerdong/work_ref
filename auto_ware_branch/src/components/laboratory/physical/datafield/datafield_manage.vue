  ...
  export default {
    ...
    methods: {
      ...
      initDicOpcData () {
        ...
        api.physicalLaboratory.labSelectStaticMap.getLabSelectStaticMapDosByParentId({parentId: this.selectedDic.id}).then((response) => {
          let data = response.data
          if (data.success) {
      ...
      delDicOpc (id) {
        ...
        api.physicalLaboratory.labSelectStaticMap.deleteLabSelectStaticMapDo(param).then((response) => {
          let data = response.data
          if (data.success) {
            this.initDicOpcData()
          } else {
