...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      add (params) {
        api.physicalLaboratory.labInstrumentAbandoned.createLabInstrumentAbandonedDo(params).then(response => {
          const data = response.data
          if (data.success === true) {
      ...
      update (params) {
        api.physicalLaboratory.labInstrumentAbandoned.updateLabInstrumentAbandonedDo(params).then(response => {
          const data = response.data
          if (data.success === true) {
            this.dialogVisible = false
            this.$emit('success')
