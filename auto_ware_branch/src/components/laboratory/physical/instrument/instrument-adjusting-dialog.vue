...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      add (params) {
        api.physicalLaboratory.labInstrumentCalibration.createLabInstrumentCalibrationDo(params).then(response => {
          const data = response.data
          if (data.success === true) {
      ...
      update (params) {
        api.physicalLaboratory.labInstrumentCalibration.updateLabInstrumentCalibrationDo(params).then(response => {
          const data = response.data
          if (data.success === true) {
            this.dialogVisible = false
            this.$emit('success')
