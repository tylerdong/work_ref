  ...
  export default {
    ...
    methods: {
      show (listItem) {
        ...
        this.form.name = listItem.row.posName
        this.form.code = listItem.row.posCode
        this.form.describe = listItem.row.posDescrip
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            let params = {
              ...
              id: this.nowListItem.posId
            }
            api.mdm.updatePosition(params).then((response) => {
