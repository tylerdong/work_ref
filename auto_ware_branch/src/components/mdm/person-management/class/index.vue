...
<template>
  <div>
    <!--<main-breadcrumb nameId="020411"></main-breadcrumb>-->
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="claName" label="名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="claCode" label="落次" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.mdm.getClassesList(params).then((response) => {
