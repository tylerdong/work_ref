  ...
  <div>
    ...
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="orgLevel" label="等级"></el-table-column>
        <el-table-column prop="orgCode" label="编码"></el-table-column>
        <el-table-column prop="orgName" label="名称"></el-table-column>
        <el-table-column prop="orgDescribe" label="描述"></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.mdm.getOrganizationList(params).then((response) => {
