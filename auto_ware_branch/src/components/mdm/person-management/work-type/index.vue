  ...
  <div>
    ...
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="worName" label="名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="productNames" label="工艺" show-overflow-tooltip></el-table-column>
        <el-table-column prop="worCode" label="编码" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.mdm.getWorkTypeList(params).then((response) => {
