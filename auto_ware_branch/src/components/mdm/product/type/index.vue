  ...
  <div>
    ...
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="typName" label="名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="typCode" label="编码" show-overflow-tooltip></el-table-column>
        <el-table-column prop="typDescripe" label="描述" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.mdm.getProductTypeList(params).then((response) => {
