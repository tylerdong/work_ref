...
<template>
  <div>
    <!--<main-breadcrumb nameId="020406"></main-breadcrumb>-->
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="proName" label="名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="productTypeName" label="产品分类名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="proCode" label="工艺编号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="proDescripe" label="描述" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.mdm.getProductProcessList(params).then((response) => {
