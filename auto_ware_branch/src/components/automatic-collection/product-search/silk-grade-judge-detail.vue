  ...
  <div>
    <div class="hy-admin__main-container">
        ...
        <el-form :inline="true" :model="search" :rules="rules" ref="search" label-width="100px">
          ...
          <el-form-item label="品名">
            <el-select v-model="search.productId" clearable placeholder="请选择品名" class="input-item-18">
              <el-option v-for="(item, index) in options.nameList" :key="index" :label="item.name" :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="工艺">
            <el-select v-model="search.processId" placeholder="请选择工艺" clearable
                       class="input-item-18">
          ...
          <el-form-item>
            <el-button type="primary" :loading="loading.search" @click="getData('search')">查询</el-button>
          </el-form-item>
        </el-form>
      </div>
      <!--table-->
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="dowSilkCode" label="丝锭编码"></el-table-column>
        ...
        <el-table-column prop="gradeName" label="判等等级"></el-table-column>
        ...
        <el-table-column label="查看">
          <template slot-scope="scope">
            <el-button type="text" @click="chechErrorReason(scope.row)">异常原因</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!--异常原因-->
    <dialog-reason ref="dialogReason"></dialog-reason>
  </div>
</template>
<script>
  ...
  export default {
    components: {
      'dialog-reason': require('./dialog-reason')
    },
    mounted () {
    ...
    methods: {
        ...
        this.$refs.search.validate(valid => {
          if (valid) {
            ...
            let param = {
              ...
              silkDownGradeId: this.search.silkDownGradeId,
            ...
            api.automatic.statement.getSilkGradeRecordList(param).then(response => {
      ...
      // 查看异常原因
      chechErrorReason (data) {
        this.$refs.dialogReason.show(data)
      },
