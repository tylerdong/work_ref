  ...
  <el-dialog :title="title" :visible.sync="dialogFormVisible" width="50%">
    <el-form :model="dialogData" :rules="rules" ref="dialogData" :label-width="formLabelWidth">
      <el-form-item label="名称" prop="storageName">
        <el-input  v-model="dialogData.storageName" placeholder="请输入名称"></el-input>
      </el-form-item>
      <el-form-item label="描述" prop="storageDescripe">
        <el-input v-model="dialogData.storageDescripe" placeholder="请输入描述"></el-input>
      </el-form-item>
    </el-form>
