  ...
  <div>
    ...
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        ...
        <el-table-column prop="number" label="工艺编号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="descripe" label="描述" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.automatic.dictionary.getProductProcessList(params).then((response) => {
