...
<template>
  <div>
    <!--<main-breadcrumb nameId="020412"></main-breadcrumb>-->
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column prop="weight" label="锭重" show-overflow-tooltip></el-table-column>
        <el-table-column prop="productTypeName" label="产品分类" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.automatic.dictionary.getWeightList(params).then((response) => {
