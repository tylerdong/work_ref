...
<template>
  <div>
    <!--<main-breadcrumb nameId="020407"></main-breadcrumb>-->
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        ...
        <el-table-column label="操作" show-overflow-tooltip>
          <template slot-scope="scope">
            <el-button @click="edit(scope)" size="small">修改</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.automatic.dictionary.getPaperTubeList(params).then((response) => {
