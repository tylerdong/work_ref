...
<template>
  <div>
    <!--<main-breadcrumb nameId="020410"></main-breadcrumb>-->
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        <el-table-column  prop="centralValue" label="中间值（dtex）" show-overflow-tooltip></el-table-column>
        <el-table-column  prop="holeNum" label="孔数（f）" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.automatic.dictionary.getSpecList(params).then((response) => {
