<template>
  <div class="measure-printing">
    <div class="search-wrapper tr">
      ...
      <el-autocomplete class="inline-input" v-model="batchNo" :fetch-suggestions="querySearch" placeholder="请输入批号"></el-autocomplete>
    ...
    <dialog-metering ref="refDialogMetering" @submitSuccess="getData"  @callback="callback"></dialog-metering>
