  ...
  <div class="all-wrapper">
    <div class="action-bar">
      <el-form :inline="true">
        ...
        <el-form-item label="批号">
          <el-select v-loading="loading.batchNum" v-model="search.batchNum" filterable placeholder="请选择批号"
                     class="input-item" clearable>
            <el-option v-for="item in batchNumOptions" :key="item.batchNo" :label="item.batchNo" :value="item.batchNo"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="位号">
          <el-input v-model="search.machineNum" placeholder="请输入位号" class="input-item"></el-input>
        </el-form-item>
        <el-form-item label="落次">
          <el-input v-model="search.downNum" placeholder="请输入落次" class="input-item"></el-input>
        </el-form-item>
    ...
    <div class="main-wrappper">
      ...
      <el-table v-loading="loading.list" :data="tableData" border @selection-change="handleSelectionChange" style="width: 100%">
        ...
        <el-table-column prop="silkCode" label="条码编号" width="130"></el-table-column>
        <el-table-column prop="batchNo" label="批号"></el-table-column>
        <el-table-column prop="line" label="线别" width="100"></el-table-column>
