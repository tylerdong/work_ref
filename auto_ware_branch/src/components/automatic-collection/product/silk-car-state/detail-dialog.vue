    ...
    <jk-dialog
      ...
      <div v-loading="loading.list">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <span class="list-label">丝锭号：</span>
            <span>{{listData.spindleNo}}</span>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
...
<script>
  ...
  export default {
    ...
    methods: {
      getData (item, all, silkcarFlowId) {
        ...
        if (all) {
          ...
          if (silkcarFlowId) {
            Object.assign(params, {silkcarFlowId: silkcarFlowId})
          }
      ...
      show (nowItem, all, silkcarFlowId) {
        this.dialogVisible = true
        this.getData(nowItem, all, silkcarFlowId)
      }
    }
  }
</script>
