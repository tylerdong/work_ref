<template>
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><img :src="`./../../static/${componyConfig.imgPath}/img/mini-logo.png`" alt=""></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img :src="`./../../static/${componyConfig.imgPath}/img/logo-inner.png`" alt=""></span>
    </a>
