      ...
      <div class="hy-admin__search-main cf">
        <div class="fr">
          ...
          <el-select v-model="searchInfo.workshopId" placeholder="请选择车间" clearable>
            <el-option v-for="item in searchInfo.workshopOptions" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
      ...
      <template>
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" element-loading-text="拼命加载中">
          ...
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              <el-button @click.native.prevent="btnModify(scope.row)" type="text">修改</el-button>
              <!--<el-button-->
