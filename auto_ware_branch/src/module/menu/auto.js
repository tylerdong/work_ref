...
export const autoMenu = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: '打印规则',
            permission: '010503',
            path: names.AUTOMATIC_PRODUCT_BARCODE_PRINTING_ORDER,
            children: []
          },
          {
            id: '020513',
            name: '丝锭绑定规则',
            permission: '010504',
            path: names.AUTOMATIC_PRODUCT_SILK_BIND_RULE,
            children: []
          }
        ]
      },
      {
        ...
        children: [
          /** -------------------- 原“生产管理/异常管理/异常信息，异常等级，异常报警管理暂时隐藏掉”-------------------------- */
          // {
          //   id: '020309',
          //   name: '异常信息',
          //   permission: '010701',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: 'fa fa-clock',
        permission: '0113',
        path: names.AUTOMATIC_SCHEDULING_MANAGEMENT,
        children: [
          {
            id: '021202',
            name: '定时调度',
          ...
          },
          {
            ...
            name: '看板配置',
            permission: '011207',
            path: names.AUTOMATIC_SCHEDULING_BOARD_CONFIG,
            children: []
          }
        ]
      },
      {
        ...
        icon: 'fas fa-search',
        permission: '011208',
        path: names.AUTOMATIC_PRODUCT_SEARCH_SILK_ERROR_DETAIL,
        children: [
          {
            id: '021401',
            name: '丝锭异常明细',
          ...
          },
          {
            ...
            name: '丝锭判等明细',
            permission: '01120802',
            path: names.AUTOMATIC_PRODUCT_SEARCH_SILK_GRADE_JUDGE_DETAIL,
            children: []
          }
        ]
      },
      {
        ...
        path: names.AUTOMATIC_PRODUCT_STATEMENT_EXCEPTION_REPORT,
        children: [
          // {
          //   id: '020901',
          //   name: '作业统计报表',
          //   permission: '011101',
          //   path: names.AUTOMATIC_PRODUCT_STATEMENT_PERSONAL_SCANNING_CAPACITY,
          //   children: []
          // },
          // {
          //   id: '020902',
          //   name: '质量报表',
          //   permission: '011102',
          //   path: names.AUTOMATIC_PRODUCT_STATEMENT_PRODUCTION_YIELD,
          //   children: []
          // },
          {
            id: '020903',
          ...
          },
          {
            ...
            name: '染色降等比率月报',
            permission: '011104',
            path: names.AUTOMATIC_PRODUCT_STATEMENT_MONTHLY_DEGRADATION,
            children: []
          },
          {
            id: '020905',
            name: '线别产量报表',
            permission: '011105',
            path: names.AUTOMATIC_PRODUCT_STATEMENT_LINENUM_PRODUCTION,
            children: []
          }
        ]
      }
