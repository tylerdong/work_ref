...
export const warehouseMenu = [
  ...
  },
  {
    ...
    children: [
      ...
      //   name: '退货处理',
      //   permission: '10021',
      //   path: names.STORAGE__WAREHOUSE_MANAGEMENT__RETURN_HANDLE,
      //   children: []
      // },
      // {
      //   id: '060208',
      //   name: '散件发运',
      //   permission: '10022',
      //   path: names.STORAGE__WAREHOUSE_MANAGEMENT__PART_DELIVERY,
      //   children: []
      // },
      // {
      //   id: '060209',
      //   name: '库间转移',
      //   permission: '10023',
      //   path: names.STORAGE__WAREHOUSE_MANAGEMENT__STORAGE_MOVE,
      //   children: []
      // },
    ]
  },
  /* 记录报表下的生产报表属于auto，仓库报表属于warehouse，但是这里是warehouse.js */
  {
    id: '0603',
    name: '记录报表',
    permission: '10027',
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: '车间下机产量日报表',
            permission: '011106',
            path: names.AUTOMATIC_PRODUCT_STATEMENT_OFFLINE_DAILY_PRODUCTION,
            children: []
          }
        ]
      },
