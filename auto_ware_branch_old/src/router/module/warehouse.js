...
export const warehouseModule = [
  ...
  /* 仓库管理 -- 退货处理 */
  {
    path: 'warehouse-management/return-handle',
    name: names.STORAGE__WAREHOUSE_MANAGEMENT__RETURN_HANDLE,
    component (resolve) {
      require(['../../components/storage-management/warehouse-management/return-handle/index.vue'], resolve)
    }
  },
  /* 仓库管理 -- 散件发运 */
  {
    path: 'warehouse-management/part-delivery',
    name: names.STORAGE__WAREHOUSE_MANAGEMENT__PART_DELIVERY,
    component (resolve) {
      require(['../../components/storage-management/warehouse-management/part-delivery/index.vue'], resolve)
    }
  },
  /* 仓库管理 -- 库间转移 */
  {
    path: 'warehouse-management/storage-move',
    name: names.STORAGE__WAREHOUSE_MANAGEMENT__STORAGE_MOVE,
    component (resolve) {
      require(['../../components/storage-management/warehouse-management/storage-move/index.vue'], resolve)
    }
  },
  /* 仓库管理 -- 异常处理 */
  {
