...
export const autoModule = [
  ...
  /* 生产报表 -- 下机产量日报表 */
  {
    path: 'statement/offline-daily-production',
    name: names.AUTOMATIC_PRODUCT_STATEMENT_OFFLINE_DAILY_PRODUCTION,
    component (resolve) {
      require(['../../components/automatic-collection/statistical-statement/offline-production/daily-production-rep.vue'], resolve)
    }
  },
  /* 看板 -- 报警看板 */
  {
