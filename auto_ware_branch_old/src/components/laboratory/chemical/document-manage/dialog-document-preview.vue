<template>
  <el-dialog :visible.sync="showPreivew" width="85%">
  <div>
    <h3>{{fileName}}</h3>
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        renderWrod (data) {
          this.wordSrc = window.global.chemicalAjaxBaseUrl + 'api/lab/report/labFileController/getLabFileIsWord?id=' + data.id
        }
      }
    }
</script>
