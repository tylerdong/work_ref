        ...
        if (this.form.title === '新增') {
          ...
          this.$refs[ruleForm].validate((valid) => {
            if (valid) {
              ...
              api.physicalLaboratory.classify.createLabDataGroupDicDo(JSON.stringify(params)).then(response => {
          ...
          this.$refs[ruleForm].validate((valid) => {
            if (valid) {
              this.loading.save = true
              api.physicalLaboratory.classify.updateLabDataGroupDicDo(JSON.stringify(params)).then(response => {
                const data = response.data
                if (data.success === true) {
