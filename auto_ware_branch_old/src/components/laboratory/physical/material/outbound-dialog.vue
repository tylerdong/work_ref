  ...
  export default {
    ...
    methods: {
      ...
      selectMaterial (materialId) {
        if (materialId) {
          api.physicalLaboratory.labMaterialController.getInventoryByLabMaterialId({id: materialId}).then(response => {
            let data = response.data
            if (data.success) {
      ...
      confirm () {
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            api.physicalLaboratory.labMaterialOutStorageController.createLabMaterialOutStorageDo(params).then(response => {
              const data = response.data
              if (data.success === true) {
