        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            if (this.type === 'edit') {
              ...
              api.physicalLaboratory.labUserRewardsController.updateLabUserRewardsDo(params).then(response => {
              ...
              api.physicalLaboratory.labUserRewardsController.createLabUserRewardsDo(params).then(response => {
                const data = response.data
                if (data.success === true) {
                  this.$emit('success')
                  this.dialogVisible = false
