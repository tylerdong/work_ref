...
<template>
  <div>
        ...
        <div class="flex-div-column hy-admin__search-main cf" ref="container" :style="classData">
          ...
          <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中" style="margin-top: 20px">
            ...
            <el-table-column label="操作" width="165">
              <template slot-scope="scope">
                <el-button @click="cancel(scope)" type="text" size="small" :loading="loading.cancel">取消</el-button>
                <el-button @click="doExperiment(scope)" type="text" size="small" :loading="loading.doExperiment">实验</el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <dialog-publish-experiment ref="refPublishExperiment" @searchListData="getListData"></dialog-publish-experiment>
  </div>
</template>
<script>
