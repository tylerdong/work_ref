...
<template>
  <div>
        ...
        <div class="flex-div-column hy-admin__search-main cf">
          ...
          <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <!-- <el-button @click="cancel(scope)" type="primary" size="small">取消</el-button> -->
                <el-button v-if="scope.row.status === 'COMPLETED'" @click="doExperiment(scope)" type="text" size="small">查看</el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <dialog-do-experiment ref="refDoExperiment"></dialog-do-experiment>
  </div>
</template>
<script>
  ...
  export default {
    components: {
      'dialog-do-experiment': require('./dialog-project-side.vue')
    },
    created () {},
    data () {
      return {
