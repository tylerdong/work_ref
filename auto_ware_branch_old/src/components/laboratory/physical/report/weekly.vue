    ...
    <div class="hy-admin__main-container">
      <div class="flex-div-row">
        ...
        <aside>
          ...
          <el-tree class="select-box" :loading="tableLoading" :data="treeData" :props="defaultProps"
  ...
  export default {
    ...
    data () {
      return {
        ...
        tableTabs: [],
        activeName: '',
        classData: {width: '', 'overflow-x': 'auto'},
        downloadHref: '',
        tableData: {},
        page: {
          current: 1,
...
//        let downHref = 'templateId=' + this.templateId
        ...
        this.downloadHref = window.global.physicalAjaxBaseUrl + 'api/lab/report/labRptRecordController/exportWeekExcelLabRptGroupVo?' + downHref
        this.$nextTick(() => {
...
//            templateId: this.templateId,
        ...
        api.physicalLaboratory.labRptRecordController.getWeekExcelLabRptGroupVo(params).then(response => {
          // 数据
