...
<template>
  <dialog-side title="新增" width="380px" :visible.sync="dialog.visible">
    <el-form :model="form" :rules="rules" ref="form" label-width="100px">
      ...
      <el-form-item label="丝车编号" required>
        <el-col :span="11">
          <el-form-item prop="numberStart">
            <el-popover
              ...
              trigger="focus">
              <h4>提示！</h4>
              <span class="popcolor">请输入6位丝车编码，首字母大写，且起始编号小于结束编号 如：F00001</span>
            </el-popover>
            <el-input v-model="form.numberStart" placeholder="起始编号" v-popover:popover></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="11">
          <el-form-item prop="numberEnd">
            <el-popover
              ...
              trigger="focus">
              <h4>提示！</h4>
              <span class="popcolor">请输入6位丝车编码，首字母大写，且结束编号大于起始编号 如：F00002</span>
            </el-popover>
            <el-input v-model="form.numberEnd" placeholder="结束编号" v-popover:popover1></el-input>
          </el-form-item>
        </el-col>
      </el-form-item>
