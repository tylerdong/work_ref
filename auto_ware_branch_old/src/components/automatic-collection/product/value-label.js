...
export {yokeTypes, frothTypes, packSource, packTypes, productTypes, rummageReason, requisitionStatus, stockStatusEnum,
  plateNumberType, storageConfig, storageType, productName, inventoryStatus}
