<template>
  <div class="measure-printing">
    ...
    <el-table :data="tableData" @selection-change="handleSelectionChange" border v-loading="loading.table" style="width: 100%">
      <el-table-column type="selection" width="55"></el-table-column>
      <el-table-column prop="singleCode" width="270" label="编号"></el-table-column>
      <!--<el-table-column label="打包类型">-->
        <!--<template scope="scope"> {{ scope.row.boxType | filterBoxType }} </template>-->
      <!--</el-table-column>-->
      ...
      <el-table-column prop="boxTime" width="180" label="包装时间">
        <!--<template prop="formatBoxTime" scope="scope">-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        product: 'dialog-staple-fiber-print',
        multipleSelection: [],
        search: {
          workshopId: '',
          lineId: '',
    ...
    methods: {
      getData () {
        ...
        api.automatic.barCode.getBoxCodeListForStorage(params).then(response => {
      ...
      batchPrint () {
        ...
        let selection = this.deepClone(this.multipleSelection)
        let first = this.deepClone(selection[0])
