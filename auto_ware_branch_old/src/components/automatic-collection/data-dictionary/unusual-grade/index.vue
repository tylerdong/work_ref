...
<template>
  <div>
    <!--<main-breadcrumb nameId="020415"></main-breadcrumb>-->
    <div class="hy-admin__main-container">
      ...
      <el-table :data="tableData" border v-loading="loading.list" element-loading-text="拼命加载中">
        ...
        <el-table-column prop="level" label="异常级别" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.automatic.dictionary.getExceptionLevelList(params).then((response) => {
