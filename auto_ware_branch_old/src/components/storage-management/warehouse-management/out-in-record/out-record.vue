      ...
      <el-form :inline="true">
        ...
        <el-form-item>
          <el-date-picker v-model="search.startDate" type="date" :picker-options="pickerOptions0" @keyup.enter="searchClick"
            @change="dtStartChange" placeholder="请选择出库开始日期"></el-date-picker>
        </el-form-item>
        <el-form-item>
          <el-date-picker v-model="search.endDate" type="date" :picker-options="pickerOptions1" @keyup.enter="searchClick"
            @change="dtEndChange" placeholder="请选择出库结束日期"></el-date-picker>
        </el-form-item>
        <el-form-item>
...
<script>
  ...
  import {productTypes, yokeTypes, packTypes, storageType} from '../../value-label.js'
  ...
  export default {
    ...
    methods: {
      ...
      getData () {
        ...
        api.storage.warehouseManagement.getRetrievalRecordInfo({
          ...
          endTime: endDate.getTime() + 86400000,
