  ...
  <div class="page-wrapper">
    <el-form :inline="true" :model="searchInfo" ref="ruleForm" :rules="rules">
      ...
      <el-form-item label="截止入库日期" prop="inboundDate">
        <el-date-picker class="width1" v-model="searchInfo.inboundDate" type="date" :picker-options="endOption" placeholder="请选择截止入库日期">
        </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="批号">
        <el-select class="width1" v-model="searchInfo.batchNo" placeholder="请选择批号" :loading="loading.batchNo" filterable clearable>
