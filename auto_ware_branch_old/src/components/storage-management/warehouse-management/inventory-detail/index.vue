...
<template>
  <div class="page-wrapper">
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-date-picker v-model="search.startInboundDate" type="date" @change="dtStartInboundDateChange"
                        placeholder="请选择开始入库日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <el-date-picker v-model="search.startScanTime" type="datetime" @change="dtStartScanTimeDateChage"
                        placeholder="请选择扫码开始时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
        <el-date-picker v-model="search.endScanTime" type="datetime" @change="dtEndScanTimeDateChage"
      ...
      <el-form-item>
        <el-select v-model="search.isInventory" placeholder="请选择盘点状态" clearable>
          <el-option v-for="item in list.inventoryStatus" :key="item.id" :label="item.name"
