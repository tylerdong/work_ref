(function () {
  ...
  var initDom = function(dom){
    ...
    var btn = $("\
      <div class='btn-bar'>\
        <span class='persons'>抽奖人数：<input type='number' class='persons-input' id='lottery-person-count' />人<span id='total-persons'></span></span>\
        <a href='javascript:;' class='btn-go' id='dh-lottery-go'>开始抽奖</a>\
        <a href='javascript:;' class='btn-list' id='dh-history-show' title='查看中奖名单'></a>\
      </div>\
    ")
    //中奖用户展示弹框
    var modal = $("\
  ...
  var readyLottery = function(){
    ...
    $('#total-persons').text(settings.data.length)
  ...
  var stopLottery = function(){
    ...
    console.log('sdsfsdfsdlf dslf ds fl');
